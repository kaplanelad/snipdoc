...
//!     - In Markdown files (like readme.md), use HTML comments: `<!-- CONTENT
//!       HERE -->`
...
//!
//! ### Injecting Snippets
//! To inject snippets, create an empty placeholder with the snippet ID and add
//! `inject_from="code"` attribute like this:
//!
//! ```text
...
//! ```
//!
//! This command captures the `SNIPPET_ID` and injects the snippet into the
//! placeholder.
//!
//! ### Managing Snippets
//!
...
//!
//! 1. Run the following command to create an empty `snipdoc.yml` file: ```sh
//!    snipdoc create-db --empty ```
//! 2. Add your snippets to `snipdoc.yml`, and use them by injecting from YAML
//!    (`inject_from="code"`).
//! For a live example, run the following command inside your project:
//!    ```sh
